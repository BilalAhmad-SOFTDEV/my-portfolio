    ...
    <section id="projects" className="relative py-24 scroll-mt-24 overflow-hidden bg-slate-50 dark:bg-gray-900 text-slate-900 dark:text-white transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            Production systems I’ve built and shipped for real clients and employers
          </motion.p>
        </div>
              ...
              >
                ...
                <div className="px-6 pb-6 sm:px-8 sm:pb-8 pt-0 mt-auto">
                  {project.confidential ? (
                    <div className="flex items-center justify-center gap-2 py-3 rounded-2xl bg-slate-100 dark:bg-white/5 border border-dashed border-slate-300 dark:border-white/10 text-xs font-black text-slate-500 dark:text-gray-400 select-none uppercase tracking-wider">
                      <i className="fa-solid fa-lock"></i> Confidential Client Project
                    </div>
                  ) : (
