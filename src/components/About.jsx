  ...
  const featureCards = [
    {
      num: '01',
      title: 'Projects',
      desc: 'Financial Automation • Healthcare SaaS • ERP Systems'
    },
    {
      num: '02',
      title: 'Performance',
      desc: '8-10x faster inserts, 20-30s queries cut to <2s'
    },
    {
      num: '03',
      title: 'Experience',
      desc: '2.5+ years backend & real-time systems'
    }
  ];
          ...
          <div className="lg:col-span-7 space-y-6">
            <motion.div variants={fadeUpVariants} className="space-y-3">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white tracking-tight leading-tight max-w-xl">
                Building high-performance backend systems for real financial and enterprise workloads.
              </h3>
            </motion.div>
            ...
            <motion.div variants={fadeUpVariants} className="space-y-4 text-slate-600 dark:text-gray-400 text-sm md:text-base leading-relaxed font-normal max-w-xl">
              <p>
                I'm Bilal Ahmad, a backend developer with 2.5+ years building financial automation systems, ERP solutions, 
                and high-performance APIs using .NET Core, C#, and SQL Server.
              </p>
              <p>
                I specialize in bot automation, real-time dashboards with SignalR, and optimizing database performance 
                for large-scale transaction processing — with a track record of improving system performance by 8-10x 
                through query optimization and batch processing.
              </p>
              <p>
                I enjoy untangling slow queries, designing clean data layers, and working directly with clients to turn 
                ambiguous requirements into reliable, production-ready systems. My work spans centralized financial 
                dashboards, healthcare SaaS payment integrations, and enterprise ERP platforms.
              </p>
            </motion.div>
          ...
          >
            <div className="bg-white/80 dark:bg-slate-950/40 backdrop-blur-md border border-slate-200 dark:border-white/5 rounded-[20px] p-6 md:p-8 flex flex-col gap-6 relative overflow-hidden group shadow-[0_0_40px_rgba(147,51,234,0.04)] dark:shadow-[0_0_40px_rgba(147,51,234,0.08)] hover:shadow-[0_0_50px_rgba(147,51,234,0.12)] dark:hover:shadow-[0_0_50px_rgba(147,51,234,0.18)] transition-all duration-500">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-slate-900 dark:text-white font-bold text-base tracking-tight">Bilal Ahmad</h4>
                  <p className="text-slate-500 dark:text-gray-500 text-xs font-medium mt-0.5">Backend Developer | .NET Developer</p>
                </div>
              </div>
              ...
              <div className="w-full bg-[#050314]/95 p-4 rounded-xl border border-slate-200 dark:border-white/5 font-mono text-[11px] md:text-[12px] leading-relaxed shadow-inner text-white">
                <div className="flex items-center gap-1.5 mb-2.5 border-b border-slate-200 dark:border-white/5 pb-2">
                  ...
                  <span className="text-[10px] text-gray-500 font-semibold ml-2">developer.cs</span>
                </div>
                <div>
                  <span className="text-purple-400">var</span>{' '}
                  <span className="text-blue-400">developer</span> = <span className="text-purple-400">new</span> &#123;
                </div>
                <div className="pl-4">
                  <span className="text-sky-300">Role</span> = <span className="text-emerald-400">"Full Stack .NET Developer"</span>,
                </div>
                <div className="pl-4">
                  <span className="text-sky-300">frontend</span>: <span className="text-emerald-400">"React, Angular, Vue"</span>,
                </div>
                <div className="pl-4">
                  <span className="text-sky-300">Backend</span> = <span className="text-emerald-400">".NET Core, C#"</span>,
                </div>
                <div className="pl-4">
                  <span className="text-sky-300">Database</span> = <span className="text-emerald-400">"SQL Server, Oracle"</span>,
                </div>
                <div className="pl-4">
                  <span className="text-sky-300">RealTime</span> = <span className="text-emerald-400">"SignalR"</span>
                </div>
                <div>&#125;;</div>
              </div>
