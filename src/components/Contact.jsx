...
const ISLAMABAD_COORDS = [33.6844, 73.0479];
...
const Contact = () => {
  ...
  const profile = {
    name: 'Bilal Ahmad',
    email: 'bilalahmad040802@gmail.com',
    location: 'Islamabad, Pakistan',
    gitHubUrl: 'https://github.com/BilalAhmad-SOFTDEV',
    linkedInUrl: 'https://www.linkedin.com/in/bilal-ahmad482',
    socialEmail: 'bilalahmad040802@gmail.com',
    phone: '+92 308 4157793',
  };
  ...
  const handleSubmit = async (e) => {
    ...
    // Guard: if EmailJS isn't configured yet, fail clearly instead of silently no-op-ing
          ...
          <div className="flex flex-col gap-6">
                ...
                <FadeUp delay={0.26} className="mt-5 pt-5 border-t border-slate-200 dark:border-white/5">
                  ...
                  <div className="flex gap-3 flex-wrap">
                    {[
                      ...
                      { href: `tel:${profile.phone.replace(/\s+/g, '')}`, icon: 'fa-solid fa-phone', label: 'Call', hover: 'hover:border-emerald-500/30 hover:bg-emerald-500/5 hover:text-emerald-600 dark:hover:text-emerald-400' },
                    ].map((s, i) => (
                      <motion.a
                        key={s.label}
                        href={s.href}
            ...
            >
              ...
              >
                ...
                <Marker position={ISLAMABAD_COORDS} icon={purpleIcon}>
                  <Popup>
                    <div className="text-center py-1">
                      <strong className="block text-sm">Bilal Ahmad</strong>
                      <span className="text-xs text-gray-500">Islamabad, Pakistan</span>
                    </div>
                  </Popup>
                </Marker>
              </MapContainer>
